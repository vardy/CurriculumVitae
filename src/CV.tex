...
\usepackage{packages} % Pull packages from /src/packages.sty
...
%TODO Add portrait photo to top of aside.
%TODO Mention blog and bring up love of FOSS. Link to blog in aside, in its own section.
